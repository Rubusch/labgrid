...
@target_factory.reg_resource
@attr.s(eq=False)
class NetworkGpiodGPIO(NetworkResource, ManagedResource):
    manager_cls = RemotePlaceManager

    """The NetworkGpiodGPIO describes a remotely accessible modern gpio line"""
    offset = attr.ib(validator=attr.validators.optional(attr.validators.instance_of(int)))
    def __attrs_post_init__(self):
        self.timeout = 10.0
        super().__attrs_post_init__()
